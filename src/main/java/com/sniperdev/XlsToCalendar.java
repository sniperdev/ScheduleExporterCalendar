...
public class XlsToCalendar {
    ...
    public ShiftTime getStartDate(int date, String shift){
        ...
        if(dayOfWeek.equals("SATURDAY") || dayOfWeek.equals("SUNDAY")){
            switch (shift){
                case "1":
                    shiftTime.setStartDate("2024-05-" + newDate + "T07:00:00+02:00");
                    shiftTime.setEndDate("2024-05-" + newDate + "T15:00:00+02:00");
                    break;
                case "2":
                    shiftTime.setStartDate("2024-05-" + newDate + "T15:00:00+02:00");
                    shiftTime.setEndDate("2024-05-" + newDate + "T22:00:00+02:00");
                    break;
            }
        }
        else {
            switch (shift){
                case "R":
                    shiftTime.setStartDate("2024-05-" + newDate + "T06:00:00+02:00");
                    shiftTime.setEndDate("2024-05-" + newDate + "T16:00:00+02:00");
                    break;
                case "1":
                    shiftTime.setStartDate("2024-05-" + newDate + "T08:00:00+02:00");
                    shiftTime.setEndDate("2024-05-" + newDate + "T16:00:00+02:00");
                    break;
                case "2":
                    shiftTime.setStartDate("2024-05-" + newDate + "T16:00:00+02:00");
                    shiftTime.setEndDate("2024-05-" + newDate + "T22:00:00+02:00");
                    break;
            }
        }
